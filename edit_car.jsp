		...
		<form action="update_car" method="post">
			<table>
				...
				<tr>
					...
					<td><input class="input" type="text" name="color"
						value="<%=car.getColor()%>" required="required"></td>
				</tr>
				<tr>
					<td class="label">FuelType</td>
					<td><input class="input" type="text" name="fuelType"
						value="<%=car.getFuelType()%>" required="required"></td>
				</tr>
				<tr>
