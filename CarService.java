...
public class CarService {
	...
	public CarDTO addCar(String name, String brand, String color, String fuelType, double price) {
	...
	public void updateCar(int id, String name, String brand, String color, String fuelType, double price) {
